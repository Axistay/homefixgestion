...
function WhatsAppChatModal({ isOpen, onClose, onStartChat,  }) {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <div className="bg-gray-100 rounded-2xl rounded-tl-sm p-4 inline-block max-w-[85%]">
              <p className="text-gray-800 text-sm">{  t("whatsappModal.defaultMessage")}</p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full gap-2 bg-green-500 text-white py-3 px-6 rounded-xl font-semibold hover:bg-green-600 transition-all duration-300 hover:scale-105 shadow-lg flex items-center justify-center space-x-2"
          >
            <FaWhatsapp size={20} />
