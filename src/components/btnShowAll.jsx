  ...
  return (
    <StyledWrapper>
      <div className="btn-conteiner">
        <a className="btn-content" href="/services" >
          <span className="btn-title text-sm ">{message}</span>
...
const StyledWrapper = styled.div`
  .btn-conteiner {
    ...
    --color-background-hover: #0d9488;
    --color-outline: #14b8a680;
  ...
  .btn-content:hover {
    ...
    box-shadow: 0 0 0.4em 0 var(--color-background-hover);
  }
